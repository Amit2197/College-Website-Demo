...
from database_setup import Admin, Base,\
    Downloads, Departments, Facaulties, Students
...
downloads1 = Downloads(file_name="Fee Structure B.Tech '19",
                       file_path="/static/files/FEE_STRUCTURE_ENGG.pdf",
                       admin_id="1")
...
downloads2 = Downloads(file_name="Fee Structure MCA'19",
                       file_path="/static/files/FEE_STRUCTURE_MCA.pdf",
                       admin_id="1")
...
downloads3 = Downloads(file_name="Fee Structure M.Tech '19",
                       file_path="/static/files/FEE_STRUCTURE_MTECH.pdf",
                       admin_id="1")
...
downloads4 = Downloads(file_name="Affidavit Anti Ragging - Student",
                       file_path="/static/files/affidavit_Student_ragging.pdf",
                       admin_id="1")
session.add(downloads4)
session.commit()


downloads5 = Downloads(file_name="Affidavit \
    Anti Ragging - Guardian",
                       file_path="/static/files/\
                           affidavit_Guardian_ragging.pdf",
                       admin_id="1")
...
departments4 = Departments(dept_name="APPLIED ELECTRONICS & \
...
facaulty3 = Facaulties(fac_name="Dr. Chandan Konar",
                       picture="/static/images/c_conar.png",
                       email="ak3@gmail.com",
                       password="123456",
...
facaulty6 = Facaulties(fac_name="Dr. Raj Kumar Samanta",
                       picture="/static/images/HOD-IT.jpg",
                       email="ak6@gmail.com",
                       password="123456",
                       ac_rank="Head of the Department",
                       edu="B.Tech.(NIT Hamirpur), \
                           M.Tech.(NIT, Bhopal), PhD (NIT, Dgp)",
                       dept_id="2",
                       admin_id="1")
...
facaulty11 = Facaulties(fac_name="Dr. Sabyasachi Chandra",
                        picture="/static/images/HOD-CE.jpg",
                        email="ak12@gmail.com",
                        password="123456",
                        ac_rank="Head of the Department",
                        edu="B.E (Civil), M.Tech (Structural Engg, IITG), \
                            Ph.D. (Struct. Engg, IITKgp)",
                        dept_id="3",
                        admin_id="1")
...
facaulty14 = Facaulties(fac_name="Dr. Kanchan Chatterjee",
                        picture="/static/images/Hod-me.jpg",
...
facaulty16 = Facaulties(fac_name="Dr. Narendranath Pathak",
                        picture="/static/images/hod-ece.png",
...
facaulty19 = Facaulties(fac_name="Dr. Sumit Banerjee",
                        picture="/static/images/hod-ee.png",
...
facaulty21 = Facaulties(fac_name="Dr. Khondekar Mofazzal Hossain",
                        picture="/static/images/hod-aeie.png",
                        email="ak24@gmail.com",
                        password="123456",
                        ac_rank="Head of the Department",
                        edu="B.Sc.(JU), B.Tech.(JU), \
                            M.Tech.(NIT, Dgp), PhD (NIT, Dgp)",
                        dept_id="6",
                        admin_id="7")
